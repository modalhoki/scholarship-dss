 ...
 * Page class
 */
class GradedSearch extends Graded
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GradedSearch";
    ...
    public function renderRow()
    {
        ...
        // Convert decimal values if posted back
        if ($this->lgd->FormValue == $this->lgd->CurrentValue && is_numeric(ConvertToFloatString($this->lgd->CurrentValue))) {
            $this->lgd->CurrentValue = ConvertToFloatString($this->lgd->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->interview->FormValue == $this->interview->CurrentValue && is_numeric(ConvertToFloatString($this->interview->CurrentValue))) {
            $this->interview->CurrentValue = ConvertToFloatString($this->interview->CurrentValue);
        }
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->lgd->EditValue = HtmlEncode($this->lgd->AdvancedSearch->SearchValue);
            ...
            $this->interview->EditValue = HtmlEncode($this->interview->AdvancedSearch->SearchValue);
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckNumber($this->lgd->AdvancedSearch->SearchValue)) {
            $this->lgd->addErrorMessage($this->lgd->getErrorMessage(false));
        }
        if (!CheckNumber($this->interview->AdvancedSearch->SearchValue)) {
            $this->interview->addErrorMessage($this->interview->getErrorMessage(false));
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("gradedlist"), "", $this->TableVar, true);
        $pageId = "search";
