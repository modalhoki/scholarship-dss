...
/**
 * Table class for graded
 */
class Graded extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'graded';
        $this->TableName = 'graded';
        ...
        // awardee
        $this->awardee = new DbField('graded', 'graded', 'x_awardee', 'awardee', 'grade.awardee', 'grade.awardee', 20, 20, -1, false, 'grade.awardee', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // total
        $this->total = new DbField('graded', 'graded', 'x_total', 'total', 'grade.total', 'grade.total', 4, 12, -1, false, 'grade.total', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // lgd
        $this->lgd = new DbField('graded', 'graded', 'x_lgd', 'lgd', 'grade.lgd', 'grade.lgd', 4, 12, -1, false, 'grade.lgd', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // interview
        $this->interview = new DbField('graded', 'graded', 'x_interview', 'interview', 'grade.interview', 'grade.interview', 4, 12, -1, false, 'grade.interview', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("grade.awardee, grade.total, grade.lgd, grade.interview");
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`interview` IS NOT NULL";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("gradedlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "gradedview") {
            return $Language->phrase("View");
        } elseif ($pageName == "gradededit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "gradedadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("gradedview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("gradedview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "gradedadd?" . $this->getUrlParm($parm);
        } else {
            $url = "gradedadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("gradededit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("gradedadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("gradeddelete", $this->getUrlParm());
    }
