...
class Grade extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('grade', 'grade', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // awardee
        $this->awardee = new DbField('grade', 'grade', 'x_awardee', 'awardee', '`awardee`', '`awardee`', 20, 20, -1, false, '`awardee`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // international
        $this->international = new DbField('grade', 'grade', 'x_international', 'international', '`international`', '`international`', 4, 12, -1, false, '`international`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        $this->international->Lookup = new Lookup('international', 'grade', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // national
        $this->national = new DbField('grade', 'grade', 'x_national', 'national', '`national`', '`national`', 4, 12, -1, false, '`national`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        $this->national->Lookup = new Lookup('national', 'grade', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // community
        $this->community = new DbField('grade', 'grade', 'x_community', 'community', '`community`', '`community`', 4, 12, -1, false, '`community`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        $this->community->Lookup = new Lookup('community', 'grade', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // experience
        $this->experience = new DbField('grade', 'grade', 'x_experience', 'experience', '`experience`', '`experience`', 4, 12, -1, false, '`experience`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        $this->experience->Lookup = new Lookup('experience', 'grade', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // gpa
        $this->gpa = new DbField('grade', 'grade', 'x_gpa', 'gpa', '`gpa`', '`gpa`', 4, 12, -1, false, '`gpa`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->gpa->Nullable = false; // NOT NULL field
        $this->gpa->Required = true; // Required field
        $this->gpa->Sortable = true; // Allow sort
        $this->gpa->Lookup = new Lookup('gpa', 'grade', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // scolastic
        $this->scolastic = new DbField('grade', 'grade', 'x_scolastic', 'scolastic', '`scolastic`', '`scolastic`', 4, 12, -1, false, '`scolastic`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        $this->scolastic->Lookup = new Lookup('scolastic', 'grade', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // lgd
        $this->lgd = new DbField('grade', 'grade', 'x_lgd', 'lgd', '`lgd`', '`lgd`', 4, 12, -1, false, '`lgd`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->lgd->Required = true; // Required field
        $this->lgd->Sortable = true; // Allow sort
        $this->lgd->Lookup = new Lookup('lgd', 'grade', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // interview
        $this->interview = new DbField('grade', 'grade', 'x_interview', 'interview', '`interview`', '`interview`', 4, 12, -1, false, '`interview`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->interview->Required = true; // Required field
        $this->interview->Sortable = true; // Allow sort
        $this->interview->Lookup = new Lookup('interview', 'grade', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // total
        $this->total = new DbField('grade', 'grade', 'x_total', 'total', '`total`', '`total`', 4, 12, -1, false, '`total`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`interview` IS NULL";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("gradelist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "gradeedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "gradeadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("gradeview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("gradeview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "gradeadd?" . $this->getUrlParm($parm);
        } else {
            $url = "gradeadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("gradeedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("gradeadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("gradedelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $curVal = trim(strval($this->awardee->CurrentValue));
        if ($curVal != "") {
            $this->awardee->EditValue = $this->awardee->lookupCacheOption($curVal);
            if ($this->awardee->EditValue === null) { // Lookup from database
                $filterWrk = "`id`" . SearchString("=", $curVal, DATATYPE_NUMBER, "");
                $sqlWrk = $this->awardee->Lookup->getSql(false, $filterWrk, '', $this, true, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                if ($ari > 0) { // Lookup values found
                    $arwrk = $this->awardee->Lookup->renderViewRow($rswrk[0]);
                    $this->awardee->EditValue = $this->awardee->displayValue($arwrk);
                } else {
                    $this->awardee->EditValue = $this->awardee->CurrentValue;
                }
            }
        } else {
            $this->awardee->EditValue = null;
        }
        $this->awardee->ViewCustomAttributes = "";
    ...
    public function rowInserting($rsold, &$rsnew)
    {
        ...
        $rsnew['international'] *= 0.0876;
        $rsnew['national'] *= 0.0484;
        $rsnew['community'] *= 0.0333;
        $rsnew['experience'] *= 0.0292;
        $rsnew['gpa'] *= 0.0324;
        $rsnew['scolastic'] *= 0.1823;
        return true;
    }
    ...
    public function rowUpdating($rsold, &$rsnew)
    {
        ...
        // To cancel, set return value to false
        $rsnew['lgd'] *= 0.2934;
        $rsnew['interview'] *= 0.2934;
        if ($rsnew['lgd'] == 0 || $rsnew['interview'] == 0) {
        	$rsnew['international'] = 0;
        	$rsnew['national'] = 0;
        	$rsnew['community'] = 0;
        	$rsnew['experience'] = 0;
        	$rsnew['gpa'] = 0;
