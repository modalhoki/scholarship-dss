...
class View1 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // name
        $this->name = new DbField('View1', 'View1', 'x_name', 'name', '`name`', '`name`', 200, 255, -1, false, '`name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // international
        $this->international = new DbField('View1', 'View1', 'x_international', 'international', '`international`', '`international`', 4, 12, -1, false, '`international`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->international->DefaultDecimalPrecision = 2; // Default decimal precision
        ...
        // national
        $this->national = new DbField('View1', 'View1', 'x_national', 'national', '`national`', '`national`', 4, 12, -1, false, '`national`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->national->DefaultDecimalPrecision = 2; // Default decimal precision
        ...
        // community
        $this->community = new DbField('View1', 'View1', 'x_community', 'community', '`community`', '`community`', 4, 12, -1, false, '`community`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->community->DefaultDecimalPrecision = 2; // Default decimal precision
        ...
        // experience
        $this->experience = new DbField('View1', 'View1', 'x_experience', 'experience', '`experience`', '`experience`', 4, 12, -1, false, '`experience`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->experience->DefaultDecimalPrecision = 2; // Default decimal precision
        ...
        // gpa
        $this->gpa = new DbField('View1', 'View1', 'x_gpa', 'gpa', '`gpa`', '`gpa`', 4, 12, -1, false, '`gpa`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->gpa->Nullable = false; // NOT NULL field
        $this->gpa->Required = true; // Required field
        $this->gpa->Sortable = true; // Allow sort
        $this->gpa->DefaultDecimalPrecision = 2; // Default decimal precision
        ...
        // scolastic
        $this->scolastic = new DbField('View1', 'View1', 'x_scolastic', 'scolastic', '`scolastic`', '`scolastic`', 4, 12, -1, false, '`scolastic`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->scolastic->DefaultDecimalPrecision = 2; // Default decimal precision
        ...
        // lgd
        $this->lgd = new DbField('View1', 'View1', 'x_lgd', 'lgd', '`lgd`', '`lgd`', 4, 12, -1, false, '`lgd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->lgd->Sortable = true; // Allow sort
        $this->lgd->DefaultDecimalPrecision = 2; // Default decimal precision
        ...
        // interview
        $this->interview = new DbField('View1', 'View1', 'x_interview', 'interview', '`interview`', '`interview`', 4, 12, -1, false, '`interview`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->interview->Sortable = true; // Allow sort
        $this->interview->DefaultDecimalPrecision = 2; // Default decimal precision
        ...
        // total
        $this->total = new DbField('View1', 'View1', 'x_total', 'total', '`total`', '`total`', 4, 12, -1, false, '`total`', false, false, false, 'FORMATTED TEXT', 'TEXT');
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // international
        $this->international->ViewValue = $this->international->CurrentValue;
        $this->international->ViewValue = FormatNumber($this->international->ViewValue, 2, -2, -2, -2);
        $this->international->ViewCustomAttributes = "";

        // national
        $this->national->ViewValue = $this->national->CurrentValue;
        $this->national->ViewValue = FormatNumber($this->national->ViewValue, 2, -2, -2, -2);
        $this->national->ViewCustomAttributes = "";

        // community
        $this->community->ViewValue = $this->community->CurrentValue;
        $this->community->ViewValue = FormatNumber($this->community->ViewValue, 2, -2, -2, -2);
        $this->community->ViewCustomAttributes = "";

        // experience
        $this->experience->ViewValue = $this->experience->CurrentValue;
        $this->experience->ViewValue = FormatNumber($this->experience->ViewValue, 2, -2, -2, -2);
        $this->experience->ViewCustomAttributes = "";

        // gpa
        $this->gpa->ViewValue = $this->gpa->CurrentValue;
        $this->gpa->ViewValue = FormatNumber($this->gpa->ViewValue, 2, -2, -2, -2);
        $this->gpa->ViewCustomAttributes = "";

        // scolastic
        $this->scolastic->ViewValue = $this->scolastic->CurrentValue;
        $this->scolastic->ViewValue = FormatNumber($this->scolastic->ViewValue, 2, -2, -2, -2);
        $this->scolastic->ViewCustomAttributes = "";

        // lgd
        $this->lgd->ViewValue = $this->lgd->CurrentValue;
        $this->lgd->ViewValue = FormatNumber($this->lgd->ViewValue, 2, -2, -2, -2);
        $this->lgd->ViewCustomAttributes = "";

        // interview
        $this->interview->ViewValue = $this->interview->CurrentValue;
        $this->interview->ViewValue = FormatNumber($this->interview->ViewValue, 2, -2, -2, -2);
    ...
    public function renderEditRow()
    {
        ...
        // international
        $this->international->EditAttrs["class"] = "form-control";
        $this->international->EditCustomAttributes = "";
        $this->international->EditValue = $this->international->CurrentValue;
        $this->international->PlaceHolder = RemoveHtml($this->international->caption());
        if (strval($this->international->EditValue) != "" && is_numeric($this->international->EditValue)) {
            $this->international->EditValue = FormatNumber($this->international->EditValue, -2, -2, -2, -2);
        }

        // national
        $this->national->EditAttrs["class"] = "form-control";
        $this->national->EditCustomAttributes = "";
        $this->national->EditValue = $this->national->CurrentValue;
        $this->national->PlaceHolder = RemoveHtml($this->national->caption());
        if (strval($this->national->EditValue) != "" && is_numeric($this->national->EditValue)) {
            $this->national->EditValue = FormatNumber($this->national->EditValue, -2, -2, -2, -2);
        }
        ...
        if (strval($this->community->EditValue) != "" && is_numeric($this->community->EditValue)) {
            $this->community->EditValue = FormatNumber($this->community->EditValue, -2, -2, -2, -2);
        }

        // experience
        $this->experience->EditAttrs["class"] = "form-control";
        $this->experience->EditCustomAttributes = "";
        $this->experience->EditValue = $this->experience->CurrentValue;
        $this->experience->PlaceHolder = RemoveHtml($this->experience->caption());
        if (strval($this->experience->EditValue) != "" && is_numeric($this->experience->EditValue)) {
            $this->experience->EditValue = FormatNumber($this->experience->EditValue, -2, -2, -2, -2);
        }

        // gpa
        $this->gpa->EditAttrs["class"] = "form-control";
        $this->gpa->EditCustomAttributes = "";
        $this->gpa->EditValue = $this->gpa->CurrentValue;
        $this->gpa->PlaceHolder = RemoveHtml($this->gpa->caption());
        if (strval($this->gpa->EditValue) != "" && is_numeric($this->gpa->EditValue)) {
            $this->gpa->EditValue = FormatNumber($this->gpa->EditValue, -2, -2, -2, -2);
        }

        // scolastic
        $this->scolastic->EditAttrs["class"] = "form-control";
        $this->scolastic->EditCustomAttributes = "";
        $this->scolastic->EditValue = $this->scolastic->CurrentValue;
        $this->scolastic->PlaceHolder = RemoveHtml($this->scolastic->caption());
        if (strval($this->scolastic->EditValue) != "" && is_numeric($this->scolastic->EditValue)) {
            $this->scolastic->EditValue = FormatNumber($this->scolastic->EditValue, -2, -2, -2, -2);
        }

        // lgd
        $this->lgd->EditAttrs["class"] = "form-control";
        $this->lgd->EditCustomAttributes = "";
        $this->lgd->EditValue = $this->lgd->CurrentValue;
        $this->lgd->PlaceHolder = RemoveHtml($this->lgd->caption());
        if (strval($this->lgd->EditValue) != "" && is_numeric($this->lgd->EditValue)) {
            $this->lgd->EditValue = FormatNumber($this->lgd->EditValue, -2, -2, -2, -2);
        }

        // interview
        $this->interview->EditAttrs["class"] = "form-control";
        $this->interview->EditCustomAttributes = "";
        $this->interview->EditValue = $this->interview->CurrentValue;
        $this->interview->PlaceHolder = RemoveHtml($this->interview->caption());
        if (strval($this->interview->EditValue) != "" && is_numeric($this->interview->EditValue)) {
            $this->interview->EditValue = FormatNumber($this->interview->EditValue, -2, -2, -2, -2);
        }
