 ...
 * Page class
 */
class DetailNilaiList extends DetailNilai
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'Detail Nilai';

    // Page object name
    public $PageObjName = "DetailNilaiList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fDetailNilailist";
    ...
    public function __construct()
    {
        ...
        // Table object (DetailNilai)
        if (!isset($GLOBALS["DetailNilai"]) || get_class($GLOBALS["DetailNilai"]) == PROJECT_NAMESPACE . "DetailNilai") {
            $GLOBALS["DetailNilai"] = &$this;
        }
        ...
        $this->AddUrl = "detailnilaiadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "detailnilaidelete";
        $this->MultiUpdateUrl = "detailnilaiupdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Detail Nilai');
        }
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fDetailNilailistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("DetailNilai"));
                $doc->Text = @$content;
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fDetailNilailistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fDetailNilailistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fDetailNilailist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
