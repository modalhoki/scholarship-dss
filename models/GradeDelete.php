 ...
 * Page class
 */
class GradeDelete extends Grade
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GradeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("gradelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("gradelist"); // Return to list
                return;
            }
        }
