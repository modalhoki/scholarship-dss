...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "directaccess.bangsawansetia.site", "port" => "3306", "user" => "lpdpdssdbuser", "password" => "lpdpdssdbuserpassword", "dbname" => "lpdpdssdb"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "VKGPFkOi20kBFeOk", // API Secret Key
